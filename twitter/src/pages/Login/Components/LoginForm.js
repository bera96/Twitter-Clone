    ...
    return (
        ...
        <div>
            ...
            <form onSubmit={handleSubmit} >
                ...
                <div className="password-input"><Input onChange={(e)=>{setState({...state,password:e.target.value})}} signUpName={name}   as="signup-input" type="password" name="Şifre" reqired="true"/></div>

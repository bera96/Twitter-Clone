...
function Buttons() {
    ...
    return (
        ...
        {register && clicked===false?( <SignUpForm/>):(null)}
        <div className="login-right" >
            ...
            <Button as="login-button-with-google" text={clicked?"Google ile oturum açın":"Google ile kaydolun"}></Button>
                ...
                <Button as="login-button" onClick={()=>setRegister(true)} text={clicked?"Telefon numarası, e-posta veya kullanıcı adı":"Telefon numarası veya e-posta adresiyle kaydol"}></Button>

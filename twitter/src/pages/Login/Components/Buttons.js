    ...
    return (
        ...
        <div className="login-right" >
            ...
            <div className="buttons">
                {clicked?(<><Button as="login-button-with-google" text={"Google ile oturum açın"} /><Button as="login-button-with-apple" text={"Apple ile giriş yap"} /><Link to="/login"> <Button as="login-button" onClick={onLoginHandler} text={"Telefon numarası, e-posta veya kullanıcı adı"}/></Link></>):(<><Button as="login-button-with-google" text={"Google ile kaydolun"} /><Button as="login-button-with-apple" text={"Apple ile kaydol"} /><Link to="/signup"> <Button as="login-button" onClick={onRegisterHandler} text={"Telefon numarası veya e-posta adresiyle kaydol"}/></Link></>)}
